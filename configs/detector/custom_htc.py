...
data_root = '/mmdetection/data/datasets'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='annotations/train_all290.json',
        ...
        seg_prefix='semantic_train/',
        data_root='/mmdetection/data/datasets',
        classes=('pig', )),
    val=dict(
        type='CocoDataset',
        ann_file='annotations/test_topview80.json',
        img_prefix='test_topview_img',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='CocoDataset',
        ann_file='annotations/test_all130.json',
        img_prefix='test_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
